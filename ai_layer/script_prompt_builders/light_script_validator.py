...
class ScriptValidator:
    ...
    # Expected main function name (must match DynamicScriptExecutor.DEFAULT_ENTRY_FUNCTION)
    ...
    def check_function_signature(self, script_code: str) -> Tuple[bool, Optional[str]]:
        """
        Check if main extraction function exists with correct signature.
        
        Expected signature: def extract_html(url: str, timeout: int = 30) -> Dict[str, Any]
